(function() {
	...
	app.config(function($stateProvider, $urlRouterProvider, $controllerProvider){
		...
		$stateProvider
			...
			.state('workshops',{
	        url:'/workshops',
	        templateUrl: viewsPrefix + 'workshops.html',
	        controller:'WorkshopListController'
	    }).state('viewWorkshop',{
	       url:'/Workshop/:id/view',
	       templateUrl: viewsPrefix + 'workshop-view.html',
	       controller:'WorkshopController'
	    }).state('newWorkshop',{
	        url:'/workshop/new',
	        templateUrl: viewsPrefix + 'workshop-add.html',
	        controller:'WorkshopCreateController'
	    }).state('editWorkshop',{
	        url:'/workshops/:id/edit',
	        templateUrl: viewsPrefix + 'workshop-edit.html',
